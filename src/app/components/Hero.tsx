            ...
            <div className="relative z-10 max-w-[1440px] mx-auto px-4 md:px-10 text-center">
                ...
                >
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
                        ShikshaGPT bridges the gap between personalized AI tutoring for students in 3-12 and institutional standards.पाठ्यक्रम विकास केन्द्र (CDC) मा आधारित. Learn freely, but stay on track.
                    </p>
